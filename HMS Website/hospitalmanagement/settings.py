...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'SENDING EMAIL' # this email will be used to send emails
...
EMAIL_RECEIVING_USER = ['RECEIVING EMAIL'] # email on which you will receive messages sent from website
